    ...
    <ErrorContent>
      <ErrorWrap>
        ...
        <ErrorList>
          ...
          <ErrorExplain>
            We&apos;re sorry, the page you requested doesn&apos;t work.
          </ErrorExplain>
          <ErrorItem>
            Go back to{' '}
            <Link to='/'>
              <ErrorLink>Main Page</ErrorLink>
            </Link>
          </ErrorItem>
          <ErrorItem>
            Please click another{' '}
            <Link to='/'>
              <ErrorLink>Menu</ErrorLink>
            </Link>
          </ErrorItem>
          <ErrorItem>
            Actually, we didn&apos;t finish this page, so go back to{' '}
            <Link to='/'>
              <ErrorLink>Main page</ErrorLink>
            </Link>
          </ErrorItem>
          <ErrorItem>
            ...
            <Link to='/'>
              <ErrorLink>contact us.</ErrorLink>
            </Link>
          </ErrorItem>
        </ErrorList>
      </ErrorWrap>
