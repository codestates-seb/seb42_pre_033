...
const ContentItemIcon = styled.svg`
  color: var(--blue-500);
`;
...
function SignupHeader() {
  return (
    <Container>
      ...
      <ContentList>
        <ContentItem>
          <ContentItemIcon width='26' height='26' viewBox='0 0 26 26'>
            <path
              fill='currentColor'
              opacity='.5'
          ...
          <ContentItemText>Get unstuck — ask a question</ContentItemText>
        </ContentItem>
        <ContentItem>
          <ContentItemIcon width='26' height='26' viewBox='0 0 26 26'>
            <path
        ...
        <ContentItem>
          ...
          <ContentItemText>Earn reputation and badges</ContentItemText>
        </ContentItem>
      </ContentList>
      <CaptionContainer>
        <Caption>
